...
int main(int argc, char *argv[])
{
    ...
    unsigned int awesomeMap = loadTexture("../images/texture/awesomeface.png");
    ourShader.use();
    ...
    Model ourModel("../images/model/nanosuit/nanosuit.obj");
//    Model ourModel("../images/model/cerberus/Cerberus.obj");
