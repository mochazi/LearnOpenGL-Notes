#include "44_parallax_mapping.hpp"
...
int main(int argc, char *argv[])
{
    ...
    unsigned int diffuseMap = loadTexture("../images/texture/bricks2.jpg");       // 漫反射图
    unsigned int normalMap = loadTexture("../images/texture/bricks2_normal.jpg"); // 法线贴图
    unsigned int depthMap = loadTexture("../images/texture/bricks2_disp.jpg");    // 高度图
