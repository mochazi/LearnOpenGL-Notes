#include "45_heigh_dynamic_range.hpp"
...
int main(int argc, char *argv[])
{
    ...
    unsigned int brickMap = loadTexture("../images/texture/brick_diffuse.jpg");               // 砖块
    unsigned int grassMap = loadTexture("../images/texture/blending_transparent_window.png"); // 草丛
