...
//    unsigned int hdrMap = loadHdrTexture("../images/texture/Alexs_Apt_2k.hdr");
    unsigned int hdrMap = loadHdrTexture("../images/texture/Ditch-River_2k.hdr");
    cubemapShader.use();
